...
public class JNode extends JNativePointer {
    ...
    public double DistanceTo(JNode node, double levelSize) {
    ...
    private native void    destroyNode(long nativePointer);
